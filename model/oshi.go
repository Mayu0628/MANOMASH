...
type Oshi struct {
	...
	LikePoint1   string    `db:"oshi_like1" form:"oshi_like1" json:"oshi_like1"`
	LikePoint2   string    `db:"oshi_like2" form:"oshi_like2" json:"oshi_like2"`
	LikePoint3   string    `db:"oshi_like3" form:"oshi_like3" json:"oshi_like3"`
